...
export const WEEKS = [
  ...
  { no: 2, icon: '✂️', title: '토큰화와 BPE', widget: 'BPE 병합 스텝퍼', llm: '—', ready: true, core: true },
  { no: 3, icon: '🧭', title: '임베딩: 단어를 벡터로', widget: '임베딩 공간 탐색기 (원-핫 · PPMI · SVD · 최근접)', llm: '—', ready: true },
  ...
  { no: 12, icon: '🌉', title: 'LLM의 한계와 RAG로', widget: '환각 해부 · 종합 프로젝트', llm: '선택', ready: true },
